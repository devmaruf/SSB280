							...
							<div class="row mg-b-15">
								...
								<div class="col-lg-6">
									<div class="form-group">
										...
										<input class="form-control" type="text" name="title" placeholder="Enter Slider Title" autocomplete="off" value="{{ $slider->title }}">
									</div>
								</div>
								...
								<div class="col-lg-6">
									<div class="form-group">
										...
										<input class="form-control" type="text" name="top_text" placeholder="Enter Slider Top Text" autocomplete="off" value="{{ $slider->top_text }}">
									</div>
								</div>
								...
								<div class="col-lg-12">
									<div class="form-group">
										...
										<textarea class="form-control" name="subtitle" id="" cols="30" rows="2" placeholder="Slider Description">{{ $slider->subtitle }}</textarea>
									</div>
								</div>
								...
								<div class="col-lg-6">
									<div class="form-group">
										...
										<input class="form-control" type="text" name="button_text" placeholder="Enter Slider Button Text" autocomplete="off" value="{{ $slider->button_text }}">
									</div>
								</div>
								...
								<div class="col-lg-6">
									<div class="form-group">
										...
										<input class="form-control" type="text" name="button_text_url" placeholder="Enter Slider Button URL" autocomplete="off" value="{{ $slider->button_text_url }}">
									</div>
								</div>
